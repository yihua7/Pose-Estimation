...
def hotmap_visualization(hotmaps, point_size, name='image', line_width=3, threshold=-1e-5, raw_image=None):
...
#    print(1)
#    if not os._exists("D:\\CS\\机器学习大作业\\Pose-Detection\\visuallization\\Visual_Image\\"):
#        os.mkdir("D:\\CS\\机器学习大作业\\Pose-Detection\\visuallization\\Visual_Image\\")
#    print(3)
    img.save("D:\\CS\\机器学习大作业\\Pose-Detection\\visuallization\\Visual_Image\\" + name + ".jpg")
    img.show()
