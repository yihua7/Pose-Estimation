...
A = load('D:\CS\机器学习大作业\Pose-Detection\data_set\label/joints.mat');
joints = A.joints;
for i = 3:size(image_list,1)
    ...
    label = label*2*pi;
    save(['D:\CS\机器学习大作业\Pose-Detection\data_set\label\heatmap\im',num2str(i-2,'%04d'),'.mat'],'image','label');
end